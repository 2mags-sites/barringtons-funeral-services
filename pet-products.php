...
?>
    ...
    <section class="page-hero">
        <div class="hero-image editable-hero-bg" data-field="hero.image" data-page="pet-products" style="background-image: url('<?php echo $content['hero']['image'] ?? ''; ?>');">
        <?php if (IS_ADMIN): ?>
    ...
    <section class="content-section">
        <div class="container">
            ...
            <div class="info-card fade-in">
                <p><?php echo editable($content['info_card']['text'] ?? '', 'info_card.text'); ?></p>
                <p><strong><?php echo editable($content['info_card']['contact_text'] ?? '', 'info_card.contact_text'); ?></strong> <?php echo editable($content['info_card']['contact_action'] ?? '', 'info_card.contact_action'); ?></p>
            </div>
        </div>
    </section>
