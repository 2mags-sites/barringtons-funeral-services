...
class EmailService {
    ...
    public function sendContactFormEmail($formData) {
        ...
        $to = EnvLoader::get('CONTACT_TO_EMAIL', 'info@barringtonsfunerals.co.uk');
        $bcc = EnvLoader::get('CONTACT_BCC_EMAIL');

        // Build email subject and body
        $subject = 'New Contact Form Submission - Barringtons Website';

        $body = "New contact form submission from Barringtons website:\n\n";
        $body .= "Name: " . $name . "\n";
        $body .= "Email: " . $email . "\n";
    ...
    private function sendContactFormConfirmation($name, $email) {
        $subject = "Thank you for contacting Barringtons";

        $body = "Dear " . $name . ",\n\n";
        $body .= "Thank you for contacting Barringtons Funeral Services. We have received your message and will respond as soon as possible.\n\n";
        $body .= "If you need immediate assistance, please call us on 0151 928 1625.\n\n";
        $body .= "Kind regards,\n";
        $body .= "The Barringtons Team\n\n";
        $body .= "---\n";
