...
?>
    ...
    <section class="page-hero">
        <div class="hero-image editable-hero-bg" data-field="hero.image" data-page="when-a-death-occurs" style="background-image: url('<?php echo $content['hero']['image'] ?? ''; ?>');">
        <?php if (IS_ADMIN): ?>
        ...
        <div class="container">
            ...
            <div class="guide-sections">
                <div class="info-card guide-section fade-in">
                    <h2><?php echo editable($content['sections']['medical_certification']['title'] ?? '', 'sections.medical_certification.title'); ?></h2>
                    <div class="info-box">
                        <p><?php echo editable($content['sections']['medical_certification']['description'] ?? '', 'sections.medical_certification.description'); ?></p>
                        <ol>
                        ...
                        <p class="note"><?php echo editable($content['sections']['medical_certification']['note'] ?? '', 'sections.medical_certification.note'); ?></p>
                    </div>
                </div>

                <div class="info-card guide-section fade-in">
                    <h2><?php echo editable($content['sections']['registration']['title'] ?? '', 'sections.registration.title'); ?></h2>
                    <p><?php echo editable($content['sections']['registration']['description'] ?? '', 'sections.registration.description'); ?></p>
                    <ul class="check-list">
                    ...
                    <div class="sub-section">
                        <h3><?php echo editable($content['sections']['registration']['who_can_register']['title'] ?? '', 'sections.registration.who_can_register.title'); ?></h3>
                        <ul>
                ...
                <div class="info-card guide-section fade-in">
                    <h2><?php echo editable($content['sections']['tell_us_once']['title'] ?? '', 'sections.tell_us_once.title'); ?></h2>
                    <p><?php echo editable($content['sections']['tell_us_once']['description'] ?? '', 'sections.tell_us_once.description'); ?></p>
                    <ul>
                    ...
                    <p class="note"><?php echo editable($content['sections']['tell_us_once']['note'] ?? '', 'sections.tell_us_once.note'); ?></p>
                </div>

                <div class="info-card guide-section fade-in">
                    <h2><?php echo editable($content['sections']['coroner']['title'] ?? '', 'sections.coroner.title'); ?></h2>
                    ...
                    <div class="info-box">
                        <h3><?php echo editable($content['sections']['coroner']['what_to_expect']['title'] ?? '', 'sections.coroner.what_to_expect.title'); ?></h3>
                        <ul>
                ...
                <div class="info-card guide-section fade-in">
                    <h2><?php echo editable($content['sections']['planning']['title'] ?? '', 'sections.planning.title'); ?></h2>
                    <div class="planning-steps">
                        <div class="planning-step">
                            ...
                            <p><strong><?php echo editable($content['sections']['planning']['burial_vs_cremation']['cremation']['title'] ?? '', 'sections.planning.burial_vs_cremation.cremation.title'); ?></strong></p>
                            <ul>
                            ...
                            <p><strong><?php echo editable($content['sections']['planning']['burial_vs_cremation']['burial']['title'] ?? '', 'sections.planning.burial_vs_cremation.burial.title'); ?></strong></p>
                            <ul>
                        ...
                        <div class="planning-step">
                            <h3><?php echo editable($content['sections']['planning']['meaningful_service']['title'] ?? '', 'sections.planning.meaningful_service.title'); ?></h3>
                ...
                <div class="info-card guide-section fade-in">
                    <h2><?php echo editable($content['sections']['practical']['title'] ?? '', 'sections.practical.title'); ?></h2>
                ...
                <div class="info-card guide-section fade-in">
                    <h2><?php echo editable($content['sections']['support']['title'] ?? '', 'sections.support.title'); ?></h2>
                    ...
                    <div class="support-box">
                        <h3><?php echo editable($content['sections']['support']['commitment']['title'] ?? '', 'sections.support.commitment.title'); ?></h3>
                        <p><?php echo editable($content['sections']['support']['commitment']['description'] ?? '', 'sections.support.commitment.description'); ?></p>
                        <p><strong><?php echo editable($content['sections']['support']['commitment']['promise_title'] ?? '', 'sections.support.commitment.promise_title'); ?></strong></p>
                        <ul>
