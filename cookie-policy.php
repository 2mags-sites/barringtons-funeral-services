...
// Load page content
$content = loadContent('cookie-policy');
...
?>
    ...
    <section class="page-hero legal-hero">
        ...
        <div class="hero-content-single">
            <h1><?php echo $content['hero']['title'] ?? 'Cookie Policy'; ?></h1>
    ...
    <section class="content-section legal-content">
        <div class="container">
            <div class="legal-document fade-in">
                ...
                <div class="cookie-preferences-cta">
                    <button onclick="showCookieBanner()" class="btn-primary">Update Cookie Preferences</button>
                </div>
            </div>
        </div>
    </section>
    ...
    .cookie-preferences-cta .btn-primary {
    ...
    .cookie-preferences-cta .btn-primary:hover {
        background: var(--navy);
